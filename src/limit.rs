...
mod tests {
  ...
  fn it_sends_an_over_75_percent_warning_message() {
    ...
    let msg = mock_messenger.sent_messages.borrow()[0].clone();
    assert_eq!(msg, "Warning: you've used up over 75% of your quota!");
  }
  ...
  fn it_sends_an_over_90_percent_warning_message() {
    ...
    let msg = mock_messenger.sent_messages.borrow()[0].clone();
    assert_eq!(msg, "Urgent warning: you've used up over 90% of your quota!");
  }
}
